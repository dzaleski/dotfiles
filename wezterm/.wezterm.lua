...
local modifier = wezterm.target_triple:find("darwin") and "CMD" or "CTRL"
return {
	font = wezterm.font("Fira Code", { weight = "Medium" }),
	font_size = 15,
	keys = {
		{ key = "1", mods = modifier, action = wezterm.action.ActivateTab(0) },
		{ key = "2", mods = modifier, action = wezterm.action.ActivateTab(1) },
		{ key = "3", mods = modifier, action = wezterm.action.ActivateTab(2) },
